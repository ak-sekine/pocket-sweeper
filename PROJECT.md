...
- [ ] サウンド
  ...
  - [ ] BGM制作
    ...
    - [ ] ChatGPTまたはCodexによるVersion 2楽曲定義JSONの直接制作運用を確認する（運用確認用BGM）
      ...
      - [ ] ChatGPTでMIDIを試作し、採用MIDIをCodexでVersion 2 JSONへ変換する運用を確認する（検証履歴。初版BGM制作では不採用）
    ...
    - [ ] 初版用タイトルBGMを人がhUGETrackerで作成する
      ...
      - [ ] Codexで確認用ROMを生成する
      - [ ] 人がSameBoyで最終試聴し、初版タイトルBGMとして確定する
    - [ ] 初版用プレイ中BGMを人がhUGETrackerで作成する
      ...
      - [ ] 人がSameBoyで最終試聴し、初版プレイ中BGMとして確定する
    - [ ] 初版用クリアBGMを人がhUGETrackerで作成する
      ...
      - [ ] 人がhUGETracker上で完成版として承認する
      - [ ] 完成後にASM/中間形式を生成し、Codexが自動確認・確認用ROM生成を行う
      - [ ] 人がSameBoyで最終試聴し、初版クリアBGMとして確定する
    - [ ] 初版用BGM3曲の統一性を確認する
