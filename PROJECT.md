  ...
  - [ ] BGM制作
    ...
    - [ ] 人がhUGETrackerでBGMを作曲する運用を確立する
      - [ ] hUGETracker中心のBGM制作フローを決める
        ...
        - [ ] hUGETracker正本データの保存場所・ファイル名規則を決める
      ...
      - [ ] hUGETrackerで短い運用確認用BGMを人が作成する
        ...
        - [ ] 人がCH2の補助パートを追加し、不協和音にならないことを確認する
        - [ ] 人がCH4のNoiseリズム・アクセントを追加し、雑音として目立たないことを確認する
        - [ ] 人が4ch全体の音量・音色・テンポ・フレーズ・ループを調整する
        - [ ] 人がhUGETracker上で完成版として承認する
      - [ ] hUGETracker完成曲をROMへ組み込む
        - [ ] 完成曲から既存方式で利用できるASMを生成する
        - [ ] ASMのorder・pattern・instrument・loop・チャンネル構成をCodexで自動確認する
        - [ ] Codexで確認用ROMを生成し、RGBDSビルドと生成物を自動確認する
        - [ ] 人がSameBoyで完成曲を試聴し、hUGETrackerとの差を確認する
      - [ ] BGMデータ管理方式を確定する
        - [ ] hUGETrackerデータ、export ASM、Version 2 JSONのリポジトリ管理方法を決める
        - [ ] 初版BGM制作の標準手順を仕様書へ反映する
    - [ ] 初版用タイトルBGMを人がhUGETrackerで作成する
      - [ ] タイトル画面に合う用途・雰囲気・長さ・ループ条件を人が決める
      - [ ] 人がhUGETrackerでCH1主旋律を作成・試聴する
      - [ ] 人がCH3を追加し、CH1 + CH3で曲を成立させる
      - [ ] 人がCH2を追加し、不協和音がないことを確認する
      - [ ] 人がCH4を追加し、Noiseが音楽的に機能することを確認する
      - [ ] 人が4ch全体を調整し、hUGETracker上で完成版として承認する
      - [ ] 完成曲から採用する中間形式/ASMを生成し、Codexで生成物を自動確認する
      - [ ] Codexで確認用ROMを生成する
      - [ ] 人がSameBoyで最終試聴する
      - [ ] タイトルBGMのhUGETracker正本データを確定する
    - [ ] 初版用プレイ中BGMを人がhUGETrackerで作成する
      - [ ] 通常プレイに合う用途・雰囲気・長さ・ループ条件を人が決める
      - [ ] 長時間繰り返しても耳障りになりにくい構成にする
      - [ ] 人がCH1主旋律、CH3土台、CH2補助、CH4リズム / accentを作成・試聴・調整する
      - [ ] CH2 / CH4がミュートされてもCH1 + CH3で曲の骨格を維持することを確認する
      - [ ] 人がhUGETracker上で完成版として承認する
      - [ ] 完成後にASM/中間形式を生成し、Codexが自動確認・確認用ROM生成を行う
      - [ ] 人がSameBoyで最終試聴する
      - [ ] プレイ中BGMのhUGETracker正本データを確定する
    - [ ] 初版用クリアBGMを人がhUGETrackerで作成する
      - [ ] ループBGMか非ループジングルかを人が判断する
      - [ ] 人がCH1、CH3、CH2、CH4をhUGETrackerで作成・試聴・調整する
      - [ ] CH2 / CH4がミュートされてもCH1 + CH3で意図を認識できることを確認する
      - [ ] 人がhUGETracker上で完成版として承認する
      - [ ] 完成後にASM/中間形式を生成し、Codexが自動確認・確認用ROM生成を行う
      - [ ] 人がSameBoyで最終試聴する
      - [ ] クリアBGMのhUGETracker正本データを確定する
    - [ ] 初版用BGM3曲の統一性を確認する
      ...
      - [ ] 各曲のhUGETracker正本データ、export ASM、確認結果を記録する
