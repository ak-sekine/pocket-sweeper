...
- タイトル画面追加後は、ゲームオーバー画面またはゲームクリア画面でSTARTボタンを押すとタイトル画面へ戻る。
...
- `RESTART` は現在のゲームを破棄して新しいゲームを開始する。
- `BACK TO TITLE` は現在のゲームを破棄してタイトル画面へ戻る。タイトル画面実装後に有効にする。
...
- BGタイルはタイル番号0～13を盤面用、14をBG消去用の空白、15以降をUIフォントに使用する。
...
- [ ] UI・追加仕様
  ...
  - [ ] ゲーム終了時のタイトル復帰
    - [ ] GAME OVER画面でSTARTを押すとタイトル画面へ戻る
    - [ ] CLEAR画面でSTARTを押すとタイトル画面へ戻る
  - [ ] リピート入力は未実装。カーソル移動実装後に必要なら検討する
  - [ ] プレイ中のSTART操作
    - [ ] 通常プレイ中にSTARTボタンを押した場合にポーズメニューを表示する
    - [ ] `RESUME` でポーズメニューを閉じて通常プレイに戻る
    - [ ] `RESTART` で現在のゲームを破棄して新しいゲームを開始する
    - [ ] `BACK TO TITLE` で現在のゲームを破棄してタイトル画面へ戻る
  - [x] ゲーム終了後のリスタート
